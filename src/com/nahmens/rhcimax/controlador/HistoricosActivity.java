...
public class HistoricosActivity extends Fragment {
	...
	private void listarHistoricos(View view) {
		...
		if(mCursorHistoricos.getCount()>0){
			...
			String[] fromTarea = new String[] { "nombreTarea", Tarea.FECHA, Tarea.HORA, "nombreEmpleadoTarea", "apellidoEmpleadoTarea", "nombreEmpresaTarea", Tarea.FECHA_FINALIZACION};
			int[] toTarea = new int[] {R.id.textViewTitulo,  R.id.textViewFil1Col2, R.id.textViewFil1Col2, R.id.textViewFil2Col1, R.id.textViewFil2Col1, R.id.textViewFil1Col1, R.id.textViewFil2Col2 };

			
			//Creamos un array adapter para desplegar cada una de las filas
			listCursorAdapterHistoricos = new ListaHistoricosCursorAdapter(contexto, R.layout.activity_fila_historico, mCursorHistoricos, fromCotizacion, toCotizacion, 0, fromTarea, toTarea);
